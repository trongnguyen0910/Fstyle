...
class CookingRecipesDetail2 extends StatefulWidget {
  @override
  State<CookingRecipesDetail2> createState() => _CookingRecipesDetail2State();
}

class _CookingRecipesDetail2State extends State<CookingRecipesDetail2> {
  @override
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(
                        'https://images.unsplash.com/photo-1505575967455-40e256f73376?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8SXRhbGlhbiUyMHN0eWxlJTIwdG9tYXRvJTIwc2FsYWR8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60',
                      ),
                    ),
                  ),
                  child: TextButton(
                      ...
                      Positioned(
                        ...
                        child: Align(
                          child: SizedBox(
                            ...
                            height: 110 * fem,
                            child: Text(
                              'This fresh Italian tomato salad recipe (Insalata di Pomodori) is a simple, easy summer side dish. BBQ or picnic and absolutely bursting with fresh flavors.',
                              style: SafeGoogleFont(
                                'Inter',
                                fontSize: 18 * ffem,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      height: 49.11 * fem,
                                      decoration: BoxDecoration(
                                        color: Color.fromARGB(86, 243, 8, 8),
                                        borderRadius:
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                height: double.infinity,
                                decoration: BoxDecoration(
                                  color: Color.fromARGB(83, 255, 83, 83),
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: ClipOval(
                                  child: Image.asset(
                                    'assets/page-1/images/nguyen.png',
                                    width: 60 * fem,
                                    height: 60 * fem,
                                  ),
                                ),
